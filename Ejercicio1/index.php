...
<body class="d-flex flex-column vh-100 justify-content-between">
    <nav class="navbar navbar-expand-lg bg-dark">
        <div class="container-fluid">
            <a class="navbar-brand text-white" href="<?php echo $nivel; ?>index.php" disabled>FCPN</a>
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav ms-auto mb-lg-0">
                    <li class="nav-item">
                        <a class="nav-link text-white" href="<?php echo 'INF/index.php'; ?>">Informatica</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link text-white" href="<?php echo 'MAT/index.php'; ?>">Matematica</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link text-white" href="<?php echo 'FIS/index.php'; ?>">Fisica</a>
                    </li>
                </ul>
            </div>
        </div>
