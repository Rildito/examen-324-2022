...
<body class="d-flex flex-column vh-100 justify-content-between">
    <nav class="navbar navbar-expand-lg bg-light">
        <div class="container-fluid">
            <a class="navbar-brand" href="<?php echo site_url(); ?>index.php/Facultad/index">FCPN</a>
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav ms-auto mb-lg-0">
                    <li class="nav-item">
                        <a class="nav-link" href="<?php echo site_url(); ?>index.php/Facultad/informatica">Informatica</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="<?php echo site_url(); ?>index.php/Facultad/matematica">Matematica</a>
                    </li>
                    <li class="nav-item">
    ...
    <div class="d-flex flex-column align-items-center justify-content-center my-5 py-5 shadow gap-3">
        ...
        <img src="<?php echo site_url();?>/assets/img/fisica.jpg" />
